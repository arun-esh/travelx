...
const signToken = (id) => {
  // console.log(`🟢 AuthController signToken()`);
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!token) {
    console.log(`🔴 AuthController PROTECT: No token found`);
    return next(
  ...
  if (!currentUser) {
    console.log(`🔴 AuthController PROTECT: User does not exist`);
    return next(
      new AppError(
  ...
  if (currentUser.changedPasswordAfter(decoded.iat)) {
    console.log(`🔴 AuthController PROTECT: User changed password`);
    return next(
  ...
  console.log(
    `🟢 AuthController PROTECT: User is logged in and has access to protected route`
  );
